...
router.post('/bug', fileUploadMiddleware('actualScreenshot', 'expectedScreenshot'), bugController.createBug); // site:string * (вид вот такой http://www.test.ru/test именно с в начале http://www. или http://localhost:3000), xpath
